...
var ol_interaction_Transform = class olinteractionTransform extends ol_interaction_Pointer {
    ...
    setDefaultStyle(options) {
        ...
        //旋转时的中心点样式
        let centerPt = new ol_style_RegularShape({
            // fill: fill,
        ...
        const rotateImage = new Icon({
            src: require('../../assets/images/openlayers/rotate.svg'),
        ...
        this.style = {
            ...
            'vertex': createStyle(vertexPt, strokedash, fill0),
            'tempVertex': createStyle(vertexPt, strokedash, fill0),
            'featureTranslate': createStyle(vertexPt, featureStroke, fill),
            'translate': createStyle(bigpt, stroke, fill),
            'rotate': createStyle(rotateImage, stroke, fill),
            'rotate0': createStyle(centerPt, stroke, fill),
