 ...
 * @LastEditTime: 2023-12-01 14:43:06
 * @FilePath: \vue2-template\src\views\three\study.vue
 * @Description: 根据公式生成几何体
-->
<template>
    <div id="canvas"></div>
</template>
    ...
    methods: {
        ...
        createMesh() {
            ...
            let radialWave = function (u, v) {
                ...
                let y =
                    (Math.sin(u * 4 * Math.PI) + Math.cos(v * 2 * Math.PI)) *
                    2.8;
            ...
            let mesh = createMultiMaterialObject(
                new ParametricGeometry(ParametricGeometries.mobius3d, 12, 12),
