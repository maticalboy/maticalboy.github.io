<template>
    <div class="vm">
        ...
        <div class="explain">
            ...
            <p>
                但当图标比较多的情况下，就需要加入非常多的HTML元素，从而造成效率降低。
            </p>
            <hr />
            <p>
                需要注意的是，这个标记使用了一张图标图片，这个图片放在项目的assets里。如果要引入这个图片，就需要使用import或者require引入这个图片。
            </p>
        </div>
    </div>
</template>
...
// 引入图标图片
import iconPng from "@/assets/images/openlayers/icon.png";
