...
export default {
    ...
    methods: {
        initMap() {
            this.map = new Map({
                ...
                view: new View({
                    ...
                    center: fromLonLat(this.London), // 伦敦
        ...
        panToLondon() {
            // 平移到伦敦
            this.map.getView().animate({
                center: fromLonLat(this.London), // 目标位置
                duration: 2000, // 动画时长
            });
        },
        elasticToMoscow() {
            // 弹性平移到莫斯科
            this.map.getView().animate({
                center: fromLonLat(this.Moscow), // 目标位置
        ...
        bounceToIstanbul() {
            // 弹跳平移到伊斯坦布尔
            this.map.getView().animate({
                center: fromLonLat(this.Istanbul),
                duration: 2000, // 动画时长
