 ...
 * @LastEditTime: 2024-01-19 16:44:08
...
export default {
    ...
    methods: {
        ...
        initCaculateLengthContainor() {
            ...
            this.containor.map.addInteraction(
                this.drawInteractionLengthContainor.modifyInteraction
            );
        },
        /**
         * @description: 添加测面交互
    ...
    mounted() {
        ...
        this.containor.map.on("contextmenu", (e) => {
            ...
            if (
                ...
                for (
                    let i = 0;
                    i < this.drawInteractionAreaContainor.pointFeature.length;
                    i++
                ) {
                    this.drawInteractionAreaContainor.vectorSource.removeFeature(
                        this.drawInteractionAreaContainor.pointFeature[i]
                    );
                }
                this.drawInteractionAreaContainor.pointFeature = [];
            }
        });
    },
};
