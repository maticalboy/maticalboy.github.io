 ...
 * @LastEditTime: 2023-11-28 15:37:01
 * @FilePath: \vue2-template\src\views\three\study.vue
 * @Description: 为场景添加光晕效果
-->
<template>
...
export default {
    ...
    methods: {
        ...
        operation() {
            ...
            this.light = new THREE.PointLight(0xbbffaa, 400, 20);
            ...
            let url1 = require("@/assets/images/three/lensflare0.png");
            let url2 = require("@/assets/images/three/lensflare2.png");
            let url3 = require("@/assets/images/three/lensflare3.png");
            let textureFlare0 = textureLoader.load(url1);
            let textureFlare1 = textureLoader.load(url2)
            let textureFlare2 = textureLoader.load(url3)
            // 定义光晕的颜色
            let flareColor = new THREE.Color(0xffffff);
            flareColor.setHSL(0.55, 0.9, 1.0);
            // 初始化眩晕
            let lensFlare=new Lensflare()
            lensFlare.addElement(new LensflareElement(textureFlare0,100, 0.0,flareColor))

            lensFlare.addElement(new LensflareElement(textureFlare1,100, 0.0,flareColor))
            lensFlare.addElement(new LensflareElement(textureFlare1,100, 0.0,flareColor))
            lensFlare.addElement(new LensflareElement(textureFlare1,100, 0.0,flareColor))

            lensFlare.addElement(new LensflareElement(textureFlare2,12, 0.6,flareColor))
            lensFlare.addElement(new LensflareElement(textureFlare2,14.5, 0.7,flareColor))
            lensFlare.addElement(new LensflareElement(textureFlare2,24, 0.9,flareColor))
            lensFlare.addElement(new LensflareElement(textureFlare2,14.5, 1.0,flareColor))
